...
browser: ['Ghi Bot WhatsApp (2022)','Safari','1.0.0'],
auth: state,
version
})
...
if (anu.action == 'add') {
kayla.sendMessage(anu.id, { text : `Halo @${num.split("@")[0]}, Selamat Datang Di Group ${metadata.subject}, Jangan Jadi Beban Ya`, mentions : [num]},{ quoted : {
key: {
fromMe: false, 
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM DARI GHI BOT"
	}
],
"selectableOptionsCount": 5
}}}})
} else if (anu.action == 'remove') {
kayla.sendMessage(anu.id, { text : `Selamat Tinggal @${num.split("@")[0]}, Semoga Dosa-Dosamu Menjadi Saldo Dana`, mentions : [num]},{ quoted : {
key: {
fromMe: false, 
participant: `0@s.whatsapp.net`, 
...({ remoteJid: "status@broadcast" }) 
